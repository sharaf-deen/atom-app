-- 20260219103000_fix_admin_list_store_orders_total_count.sql
-- Fix: total_count must match function return type (count() returns bigint).
-- We cast count(*) over() to integer to match declared return type.
