-- 20260219094500_admin_list_store_orders_rpc_v2.sql
-- Fix: OFFSET/LIMIT cannot use CTE variables inside SQL-language functions in some contexts.
-- We switch to PL/pgSQL and use calculated integers.
      ...
      and (
        ...
        or exists (
          ...
          where pr.user_id = coalesce(o.owner_uid, o.created_by, o.user_id, o.member_id)
            and (
              (pr.first_name is not null and pr.first_name ilike ('%' || v_q || '%'))
