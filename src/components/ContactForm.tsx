...
export default function ContactForm() {
  ...
  function Tabs() {
    const base = 'text-sm px-3 py-1.5 rounded-2xl border transition-colors'
    const active = 'bg-[hsl(var(--primary))] text-white border-[hsl(var(--primary))]'
    const inactive = 'bg-[hsl(var(--card))] text-[hsl(var(--muted))] border-[hsl(var(--border))] hover:bg-[hsl(var(--muted))]/10'
