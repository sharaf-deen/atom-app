    ...
    <div className="space-y-5">
      <div className="grid gap-3 sm:grid-cols-3">
        ...
        <div className="rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-4 shadow-soft">
          ...
          <div className="mt-1 text-sm font-semibold">Generated from active templates</div>
        </div>
      </div>
        ...
        <form onSubmit={saveTemplate} className="space-y-4 rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-4 shadow-soft sm:p-5">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <label className="space-y-1.5 text-sm font-medium md:col-span-2">
              ...
              <Textarea value={notes} onChange={(event) => setNotes(event.target.value)} rows={3} maxLength={2000} placeholder="Optional operational note. Never shown to members." />
            </label>
          </div>
      ...
      <ConfirmActionModal
        ...
        description={statusTarget?.nextActive ? 'The template becomes active again for future structured schedule use.' : 'The template is kept for history but is removed from the active structured timetable.'}
