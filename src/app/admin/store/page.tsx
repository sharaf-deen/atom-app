                    ...
                    <Card key={p.id} hover>
                      <CardContent className="py-4 space-y-2">
                        ...
                        <AdminProductQuickEdit
                          ...
                          allowPreorder={Boolean((p as any).allow_preorder ?? (p as any).allowPreorder ?? false)}
                          lowStockThreshold={Number((p as any).low_stock_threshold ?? (p as any).lowStockThreshold ?? 0)}
                        />
                      </CardContent>
                    </Card>
                  )
